        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-yellow-400 mb-4">
              Daily Mining Overview
            </h2>
            <p className="text-base md:text-lg text-gray-300 mb-6 leading-relaxed">
              Earn daily FSN tokens based on your membership level. Upgrade to
              unlock higher rewards and exclusive benefits.
            </p>
            <div className="bg-[#1B263B] p-6 rounded-xl shadow-inner">
              <ul className="text-sm md:text-base text-gray-200 space-y-2">
                <li>⚫ Economy Class: 600 FSN / 12 hour</li>
                <li>🔵 Business Class: 3000 FSN / 12 hour</li>
                <li>🟡 First Class: 6000 FSN / 12 hour</li>
              </ul>
            </div>
            <div className="mt-8">
              <a
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="text-base md:text-lg text-gray-300 mb-6">
              Coming soon: Fun and engaging mini-games that let you earn more
              FSN!
            </p>
            <a
              href="/playtoearn"
      ...
      <section className="w-full bg-white py-16 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 text-lg mb-6">
            FlySky Network is a next-generation digital economy platform
            combining mining, staking, gaming, and NFTs into one seamless
            experience.
          </p>
          <Link
            to="/about"
      ...
      <section className="w-full bg-gray-100 py-16 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 mb-6 text-lg">
            Stake your FSN tokens and earn passive income with flexible plans
            and high returns.
          </p>
          <a
            href="/staking"
