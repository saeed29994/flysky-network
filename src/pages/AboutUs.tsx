    ...
    <section id="about" className="bg-[#0D1B2A] text-white py-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="my-10 text-left">
          ...
          <p className="text-lg mb-4">
            <strong>Main Sale:</strong> The official Initial Coin Offering (ICO)
        ...
        <p className="text-lg mb-6">Be part of our growing ecosystem today.</p>

        <a
          href="/join"
          className="inline-block bg-yellow-400 text-[#0D1B2A] font-semibold py-2 px-6 rounded-full hover:bg-yellow-300 transition"
        >
          Join Now
        </a>
      </div>
