            ...
            ">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg font-bold text-white">Admin Support</h2>
                    <p className="text-blue-100 text-sm">Support Team</p>
                  </div>
                </div>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="font-medium text-white">
                            {message.sender === 'user' ? userName : 'Admin Support'}
                          </span>
              ...
              <footer className="flex items-end gap-3 p-4 border-t border-white/20 min-h-[80px] bg-slate-900/50">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-500 disabled:from-gray-400 disabled:to-gray-500 text-white rounded-xl font-medium transition-all duration-200 flex items-center gap-2 disabled:cursor-not-allowed"
                >
                  {loading ? (
