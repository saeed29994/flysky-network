...
export const NotificationBell: React.FC = () => {
  ...
  const handleNotificationClick = (notification: any) => {
    ...
    if (notification.type === 'admin_reply') {
      // For admin replies, navigate to inbox and potentially open the message modal
      navigate('/inbox');
      // You could also emit an event or use a global state to open the specific message modal
    } else {
      // For other notifications, navigate to inbox
      navigate('/inbox');
    }
  };
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className={`flex items-center mt-2 ${isRTL ? 'flex-row-reverse justify-between' : 'justify-between'}`}>
                            ...
                            <span className={`text-xs px-2 py-1 rounded-full ${
                              ...
                              notification.type === 'admin_reply' ? 'bg-purple-500/20 text-purple-400' :
