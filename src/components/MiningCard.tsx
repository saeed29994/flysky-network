...
import EarningsTableCard from "./EarningsTableCard";
    ...
    <div className="w-full bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 pb-12">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
          {/* Banner Section - Integrated into Grid */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {/* Earnings Table Card */}
        <div className="mt-6"><EarningsTableCard /></div>
