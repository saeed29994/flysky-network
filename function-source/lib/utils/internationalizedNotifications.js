 ...
 */
async function sendInternationalizedNotification(userId, title, body, platforms, data, skipUserCollection = false) {
    try {
 ...
 */
async function sendInternationalizedNotificationsToUsers(userIds, title, body, platforms, data) {
    const results = [];
    let successCount = 0;
    let failureCount = 0;
 ...
 * @returns Object with success and failure counts
 */
async function sendInternationalizedNotificationToAllUsers(title, body, platforms, data) {
    try {
 ...
 * @returns Object with success and failure counts
 */
async function sendInternationalizedNotificationToPlans(selectedPlans, title, body, platforms, data) {
    try {
