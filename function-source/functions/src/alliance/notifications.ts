 ...
 */
export const onPublicMessageCreate = functions.firestore
 ...
 */
export const onAllianceMessageCreate = functions.firestore
  ...
  .onCreate(async (snapshot, context) => {
    ...
    const notificationPromises = membersSnapshot.docs.map(memberDoc =>
      createNotification(db, memberDoc.data().uid, {
        type: 'message',
        relatedId: snapshot.id,
        senderId,
        senderName: senderData.name,
 ...
 */
export const onGlobalPostCreate = functions.firestore
  ...
  .onCreate(async (snapshot, context) => {
    ...
    try {
      ...
      const notificationPromises = usersSnapshot.docs.map(userDoc =>
        createNotification(db, userDoc.id, {
          type: 'post',
          relatedId: snapshot.id,
          senderId: authorId,
 ...
 */
export const onAlliancePostCreate = functions.firestore
 ...
 */
export const onGlobalCommentCreate = functions.firestore
 ...
 * Creates notification for the post author
 */
export const onAllianceCommentCreate = functions.firestore
 ...
 * Creates notification for the post author
 */
export const onGlobalPostReactionCreate = functions.firestore
 ...
 * Creates notification for the post author
 */
export const onAlliancePostReactionCreate = functions.firestore
