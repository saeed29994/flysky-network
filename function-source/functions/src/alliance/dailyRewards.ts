 ...
 */
async function hasReceivedRewardToday(
  db: admin.firestore.Firestore,
  uid: string,
  activityType: 'post' | 'reaction' | 'chat'
): Promise<boolean> {
  try {
 ...
 */
export const onGlobalPostCreateReward = functions.firestore
 ...
 */
export const onAlliancePostCreateReward = functions.firestore
 ...
 */
export const onGlobalPostReactionReward = functions.firestore
 ...
 */
export const onAlliancePostReactionReward = functions.firestore
 ...
 */
export const onPublicMessageReward = functions.firestore
 ...
 */
export const onAllianceMessageReward = functions.firestore
 ...
 */
export const initializeAllianceUser = functions.https.onCall(async (data, context) => {
  if (!context.auth) {
 ...
 */
export const getUserDailyRewards = functions.https.onCall(async (data, context) => {
  if (!context.auth) {
    throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
  }
 ...
 */
export const getUserDailyRewardsSummary = functions.https.onCall(async (data, context) => {
  if (!context.auth) {
    throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
  }
  ...
  todayRewardsSnapshot.docs.forEach(doc => {
    const data = doc.data();
    const activityType = data.activityType as 'post' | 'reaction' | 'chat';
